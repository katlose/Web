...
$vorname = $nachname = $geburtsdatum = $strasse = $hnumber = $plz = $ort = $tnumber = $mnumber = $email = "";
$vornameErr = $nachnameErr = $geburtsdatumErr = $strasseErr = $hnumberErr = $plzErr = $ortErr = $tnumberErr = $mnumberErr = $emailErr = "";
$output = "";
...
if (isset($_POST['aktion']) and $_POST['aktion']=='speichern') {
	...
	
    {
        // speichern
		 $update = $erg->prepare("
                 UPDATE patientdata SET vorname=?, nachname=?, geburtsdatum=?, strasse=?, hnummer=?, plz=?, ort=?, telefonnummer=?, mobilnummer=?, email=? WHERE uid=? LIMIT 1
        ");
